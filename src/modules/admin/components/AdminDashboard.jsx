...
const MENU_ITEMS = [
  ...
  },
  {
    ...
    label: "Períodos de Disponibilidad",
  },
  {
    id: "administradores",
    icon: (
                            ...
                            >
                              ...
                              {group.predicciones.map((res, i) => (
                                <div
                                  ...
                                  style={{
                                    display:
                                      "flex" /* <- ESTO SEPARA LOS ELEMENTOS */,
                                    justifyContent:
                                      "space-between" /* <- FECHA IZQ, CANTIDAD DER */,
                                    alignItems: "center",
                                    marginBottom: "10px",
                                    background: "white",
                                    padding: "12px 16px",
                                ...
                                >
                                  ...
                                  >
                                    {Number(res.cantidad_estimada).toFixed(0)}{" "}
                                    unds.
                                  </span>
                                </div>
                              ))}
